...
header.innerText = "Fetching World Countries Data With Promise and XMLHttpRequest";
...
function getinfo() {
  ...
  getinfo().then(data=>{
    ...
    for(let i=0;i<data.length;i++){
        ...
        outer_div.setAttribute("style","display:flex;justify-content:center;padding:5px; margin:5px 0")
        outer_div.setAttribute("class","col-3")
